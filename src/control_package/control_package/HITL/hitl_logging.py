...
def main():
    ...
    node = LoggerNode(success_log_file_path=f"/home/irol/workspace/Robust-Sweeping-in-Cluttered-Shelves/src/control_package/logs/hitl/sweep_policy_success_log.csv",
                       trajectory_log_file_path=f"/home/irol/workspace/Robust-Sweeping-in-Cluttered-Shelves/src/control_package/logs/hitl/sweep_policy_trajectory_log0319_{args.episode_num}.csv",
                       object_log_file_path=f"/home/irol/workspace/Robust-Sweeping-in-Cluttered-Shelves/src/control_package/logs/hitl/sweep_policy_object_log0319_{args.episode_num}.csv",
